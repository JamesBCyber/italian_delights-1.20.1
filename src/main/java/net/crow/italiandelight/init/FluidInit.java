...
public class FluidInit {
    ...
    public static final RegistryObject<FluidType> GLOWBERRY_WINE_FLUID_TYPE = FLUID_TYPES.register("glowberry_wine_type", () -> new AlcoholFluidType(0xFF000017));
    ...
    public static final RegistryObject<FluidType> ROSE_WINE_FLUID_TYPE = FLUID_TYPES.register("rose_wine_type", () -> new AlcoholFluidType(0xF317FFFF));
    ...
    public static final RegistryObject<FluidType> HELLHOUND_WINE_FLUID_TYPE = FLUID_TYPES.register("hellhound_wine_type", () -> new AlcoholFluidType(0xF317FFFF));
    ...
    public static final RegistryObject<FluidType> DRAGONBORN_WINE_FLUID_TYPE = FLUID_TYPES.register("dragonborn_wine_type", () -> new AlcoholFluidType(0xF317FFFF));
    ...
    public static final RegistryObject<FluidType> HASTING_WINE_FLUID_TYPE = FLUID_TYPES.register("hasting_wine_type", () -> new AlcoholFluidType(0xF317FFFF));
    ...
    public static final RegistryObject<FluidType> SWEETBERRY_WINE_FLUID_TYPE = FLUID_TYPES.register("sweetberry_wine_type", () -> new AlcoholFluidType(0xF317FFFF));
    ...
    public static final RegistryObject<FluidType> SPUMANTE_FLUID_TYPE = FLUID_TYPES.register("spumante_type", () -> new AlcoholFluidType(0xF317FFFF));
